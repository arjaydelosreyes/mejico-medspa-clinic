...
export function LandingAbout() {
  return (
    <section className="py-16" style={{ background: 'linear-gradient(135deg, #f5f7fa, #e4e8ff)' }}>
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold" style={{ color: '#382d6e' }}>ABOUT US</h2>
        <p className="mt-2 text-gray-600">Excellence in Medical Aesthetics</p>
      </div>

      {/* Our Story */}
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center mb-16">
        <Image
        ...
        />
        <div>
          <h3 className="text-2xl font-bold mb-4" style={{ color: '#382d6e' }}>Our Story</h3>
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center mb-16">
        <div className="order-2 md:order-1">
          <h3 className="text-2xl font-bold mb-4" style={{ color: '#382d6e' }}>Meet Our Founder</h3>
          <p className="text-gray-700 leading-relaxed">
        ...
        {[
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-lg font-bold" style={{ color: '#382d6e' }}>{title}</h4>
            </div>
